...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        View::composer('components.layouts.admin', function ($view) {
            ...
            $view->with('pendingOrdersCount', Order::where('status', 'pending')->paymentConfirmed()->whereNull('admin_viewed_at')->count());
            $view->with('paymentIssuesCount', Order::whereIn('payment_status', ['pending', 'failed'])->where('payment_method', '!=', 'cod')->whereNull('admin_viewed_at')->count());
