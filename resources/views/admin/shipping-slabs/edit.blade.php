<x-layouts.admin title="Edit Shipping Slab">
    <div class="page-header">
        <h1 class="page-title">Edit Shipping Slab</h1>
        <a href="{{ route('admin.shipping-slabs.index') }}" class="btn btn-secondary">&larr; Back to Shipping Slabs</a>
    </div>

    <form method="POST" action="{{ route('admin.shipping-slabs.update', $shippingSlab) }}" class="max-w-form-lg">
        @csrf
        @method('PUT')
